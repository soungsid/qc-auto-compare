  ...
  return (
    <div className="min-h-screen bg-creme dark:bg-dark-primary text-charbon-900 dark:text-creme-300 transition-colors flex flex-col">
      ...
      <main className="mx-auto w-full max-w-4xl px-6 py-12 flex-1">
        <article className="bg-white dark:bg-dark-primary rounded-xl border border-creme-400 dark:border-charbon-800 p-8 md:p-12 shadow-sm">
          <h1 className="text-3xl md:text-4xl font-bold text-charbon-900 dark:text-creme-300 mb-6">
          ...
          <div className="prose dark:prose-invert max-w-none space-y-6 text-charbon-700 dark:text-creme-500">
            ...
            <section>
              ...
              <div className="bg-creme-200 dark:bg-charbon-900/20 p-6 rounded-lg border border-ambre-200 dark:border-charbon-800">
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <svg className="w-6 h-6 text-charbon-700 dark:text-ambre-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="bg-creme dark:bg-dark-card p-4 rounded-lg">
                  <p className="font-semibold text-charbon-900 dark:text-creme-300">Nissan</p>
                  <p className="text-sm text-acier-500 dark:text-acier-400">4 concessionnaires</p>
                </div>
                <div className="bg-creme dark:bg-dark-card p-4 rounded-lg">
                  <p className="font-semibold text-charbon-900 dark:text-creme-300">Toyota</p>
                  <p className="text-sm text-acier-500 dark:text-acier-400">3 concessionnaires</p>
                </div>
                <div className="bg-creme dark:bg-dark-card p-4 rounded-lg">
                  <p className="font-semibold text-charbon-900 dark:text-creme-300">Hyundai</p>
                  <p className="text-sm text-acier-500 dark:text-acier-400">3 concessionnaires</p>
                </div>
                <div className="bg-creme dark:bg-dark-card p-4 rounded-lg">
                  <p className="font-semibold text-charbon-900 dark:text-creme-300">Kia</p>
                  <p className="text-sm text-acier-500 dark:text-acier-400">3 concessionnaires</p>
                </div>
                <div className="bg-creme dark:bg-dark-card p-4 rounded-lg">
                  <p className="font-semibold text-charbon-900 dark:text-creme-300">Chevrolet</p>
                  <p className="text-sm text-acier-500 dark:text-acier-400">2 concessionnaires</p>
                </div>
                <div className="bg-creme dark:bg-dark-card p-4 rounded-lg">
                  <p className="font-semibold text-charbon-900 dark:text-creme-300">+ Plus</p>
                  <p className="text-sm text-acier-500 dark:text-acier-400">En expansion</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="mt-4">
                <a
                  href="/contact"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-charbon-900 dark:bg-creme-300 text-white dark:text-charbon-900 font-medium rounded-lg hover:bg-charbon-800 dark:hover:bg-white transition-colors"
                >
                  Contactez-nous
